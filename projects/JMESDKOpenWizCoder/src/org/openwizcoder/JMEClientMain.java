...
public class JMEClientMain extends OpenWizCoderApp {
    ...
    public void Init_client() throws IOException{
        ...
        try {
            myClient = Network.connectToServer(JMEServerMain.NAME, JMEServerMain.VERSION,
                "127.0.0.1", JMEServerMain.PORT, JMEServerMain.UDP_PORT);            
            myClient.start();
            //new ClientListener();
